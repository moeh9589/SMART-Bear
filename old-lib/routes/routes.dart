...
void moveToStudentDashboardReplacement(BuildContext context) => Navigator.pushReplacement(
  context,
  MaterialPageRoute(builder: (context) => const StudentDashboardView())
);

void moveToAdminDashboardReplacement(BuildContext context) => Navigator.pushReplacement(
  context,
